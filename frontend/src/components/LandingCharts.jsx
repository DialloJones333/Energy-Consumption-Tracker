    ...
    return (
        <div className="flex flex-col items-center gap-8 mt-8">
            <div className="flex flex-wrap justify-center gap-8 w-full">
                <div className="custom-w-104 custom-h-72 bg-gray-100 shadow-md flex items-center justify-center rounded-lg">
                    <LandingLineChart />
                </div>
                <div className="custom-w-104 custom-h-72 bg-gray-100 shadow-md flex items-center justify-center rounded-lg">
                    <LandingPieChart />
            ...
            <div className="w-full max-w-4xl h-96 bg-gray-100 shadow-lg flex items-center justify-center rounded-lg">
                <LandingAreaChart />
            </div>
        </div>
    )
