...
const LandingNavbar = () => (
    <nav className="flex items-center justify-between p-5 bg-gray-100">
        ...
        <div className="nav-links flex space-x-5">
            <Link to="/signup" className="text-gray-700 font-bold hover:text-blue-500">Signup</Link>
            <Link to="/login" className="text-gray-700 font-bold hover:text-blue-500">Login</Link>
        </div>
    </nav>
);
