...
const Footer = () => (
    <footer className="footer p-4 bg-inherit text-inherit mt-auto flex justify-between items-center">
        <aside className="flex items-center grid-flow-col">
            ...
            <p className=' font-bold'>2024 © Diallo Jones - All rights reserved</p>
        </aside> 
        <nav className="flex justify-center items-center space-x-3 md:place-self-center md:justify-self-end">
            <a href="https://github.com/DialloJones333"className="hover:text-gray-400" target="_blank" rel="noopener noreferrer">
                <ReactSVG src={githubicon} className="w-6 h-6 fill-current hover:text-purple-600" />
            </a>
            ...
            <a href="mailto:diallojones23@gmail.com" className="hover:text-gray-400" target="_blank" rel="noopener noreferrer">
                <ReactSVG src={emailicon} className="w-6 h-5 fill-current hover:text-red-500" />
            </a>
        </nav>
    </footer>
)
